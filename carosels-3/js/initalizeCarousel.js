function getSlidesPerView() {
  if (window.innerWidth >= 1025) return 6; // Large screens
  if (window.innerWidth >= 640) return 4; // Medium screens
...
function updateCarousel() {
  ...
  for (let i = 0; i < totalSlideSets; i++) {
    ...
    dotNavigation.appendChild(dotWrap); 
  }
...
function showSlide(index, stopTransition) {
  ...
  if (stopTransition) {
    ...
    slideContainer.style.transition = "transform 0.8s ease 0ms";
  }
